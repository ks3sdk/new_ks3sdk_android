...
public class LengthCheckInputStream extends FilterInputStream {
     ...
     * @param expectedLength the total length of the data in bytes expected to be read from
     *                       the underlying input stream; must be non-negative.
     * @param includeSkipped true if bytes skipped are to be considered as part of the data
     ...
     * {@inheritDoc}
     *
     * @throws Ks3ClientException if the data length read has exceeded the expected total, or
